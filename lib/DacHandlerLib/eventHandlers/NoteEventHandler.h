...
class NoteEventHandler : public DacEventHandler {
    ...
    private:
        ...
        bool _handleNoteOnEvent(uint8_t index, const MidiNoteOnEvent *event, DacValues *dacValues);
        bool _handleNoteOffEvent(uint8_t index, const MidiNoteOffEvent *event, DacValues *dacValues);
};
